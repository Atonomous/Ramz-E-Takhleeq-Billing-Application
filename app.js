...
function initializeDefaultData() {
    ...
    if (products.length === 0) {
        products = [
            ...
            // Crochet items
            { id: Date.now() + 500, categoryId: 9, name: 'Bandana Black', costPrice: 180, salePrice: 600, soldCount: 0 },
            { id: Date.now() + 501, categoryId: 9, name: 'Bandana White', costPrice: 200, salePrice: 1000, soldCount: 0 },
            { id: Date.now() + 502, categoryId: 9, name: 'Bandana Blue', costPrice: 250, salePrice: 1500, soldCount: 0 },
            { id: Date.now() + 503, categoryId: 9, name: 'Headband Blue', costPrice: 150, salePrice: 100, soldCount: 0 },
            { id: Date.now() + 504, categoryId: 9, name: 'Headband White', costPrice: 150, salePrice: 100, soldCount: 0 },
            { id: Date.now() + 505, categoryId: 9, name: 'Headband Black', costPrice: 150, salePrice: 100, soldCount: 0 },
            { id: Date.now() + 506, categoryId: 9, name: 'Headband Pink', costPrice: 200, salePrice: 150, soldCount: 0 },
            { id: Date.now() + 507, categoryId: 9, name: 'Bow Small', costPrice: 120, salePrice: 80, soldCount: 0 },
            { id: Date.now() + 508, categoryId: 9, name: 'Bow Large', costPrice: 180, salePrice: 130, soldCount: 0 },
            { id: Date.now() + 509, categoryId: 9, name: 'Heart Keychain', costPrice: 250, salePrice: 175, soldCount: 0 },
            { id: Date.now() + 510, categoryId: 9, name: 'Bookmarks Crochet', costPrice: 100, salePrice: 80, soldCount: 0 },
            { id: Date.now() + 511, categoryId: 9, name: 'Gajras', costPrice: 750, salePrice: 550, soldCount: 0 },
            { id: Date.now() + 512, categoryId: 9, name: 'Handwarmers White', costPrice: 450, salePrice: 330, soldCount: 0 },
            { id: Date.now() + 513, categoryId: 9, name: 'Handwarmers Others', costPrice: 400, salePrice: 300, soldCount: 0 },
            { id: Date.now() + 514, categoryId: 9, name: 'Handwarmers Purple', costPrice: 660, salePrice: 425, soldCount: 0 },
            // Baking
            { id: Date.now() + 600, categoryId: 10, name: 'Universal', costPrice: 0, salePrice: 0, soldCount: 0 },
            // Jewelry (J-001 to J-050)
            { id: Date.now() + 700, categoryId: 11, name: 'J-001', costPrice: 250, salePrice: 300, soldCount: 0 },
            { id: Date.now() + 701, categoryId: 11, name: 'J-002', costPrice: 450, salePrice: 500, soldCount: 0 },
            { id: Date.now() + 702, categoryId: 11, name: 'J-003', costPrice: 300, salePrice: 350, soldCount: 0 },
            { id: Date.now() + 703, categoryId: 11, name: 'J-004', costPrice: 300, salePrice: 400, soldCount: 0 },
            { id: Date.now() + 704, categoryId: 11, name: 'J-005', costPrice: 160, salePrice: 250, soldCount: 0 },
            { id: Date.now() + 705, categoryId: 11, name: 'J-006', costPrice: 160, salePrice: 250, soldCount: 0 },
            { id: Date.now() + 706, categoryId: 11, name: 'J-007', costPrice: 285, salePrice: 350, soldCount: 0 },
            { id: Date.now() + 707, categoryId: 11, name: 'J-008', costPrice: 370, salePrice: 500, soldCount: 0 },
            { id: Date.now() + 708, categoryId: 11, name: 'J-009', costPrice: 200, salePrice: 300, soldCount: 0 },
            { id: Date.now() + 709, categoryId: 11, name: 'J-010', costPrice: 290, salePrice: 350, soldCount: 0 },
            { id: Date.now() + 710, categoryId: 11, name: 'J-011', costPrice: 360, salePrice: 500, soldCount: 0 },
            { id: Date.now() + 711, categoryId: 11, name: 'J-012', costPrice: 360, salePrice: 500, soldCount: 0 },
            { id: Date.now() + 712, categoryId: 11, name: 'J-013', costPrice: 250, salePrice: 450, soldCount: 0 },
            { id: Date.now() + 713, categoryId: 11, name: 'J-014', costPrice: 200, salePrice: 250, soldCount: 0 },
            { id: Date.now() + 714, categoryId: 11, name: 'J-015', costPrice: 160, salePrice: 250, soldCount: 0 },
            { id: Date.now() + 715, categoryId: 11, name: 'J-016', costPrice: 260, salePrice: 500, soldCount: 0 },
            { id: Date.now() + 716, categoryId: 11, name: 'J-017', costPrice: 400, salePrice: 500, soldCount: 0 },
            { id: Date.now() + 717, categoryId: 11, name: 'J-018', costPrice: 300, salePrice: 350, soldCount: 0 },
            { id: Date.now() + 718, categoryId: 11, name: 'J-019', costPrice: 200, salePrice: 300, soldCount: 0 },
            { id: Date.now() + 719, categoryId: 11, name: 'J-020', costPrice: 125, salePrice: 300, soldCount: 0 },
            { id: Date.now() + 720, categoryId: 11, name: 'J-021', costPrice: 160, salePrice: 250, soldCount: 0 },
            { id: Date.now() + 721, categoryId: 11, name: 'J-022', costPrice: 305, salePrice: 400, soldCount: 0 },
            { id: Date.now() + 722, categoryId: 11, name: 'J-023', costPrice: 145, salePrice: 200, soldCount: 0 },
            { id: Date.now() + 723, categoryId: 11, name: 'J-024', costPrice: 135, salePrice: 250, soldCount: 0 },
            { id: Date.now() + 724, categoryId: 11, name: 'J-025', costPrice: 250, salePrice: 400, soldCount: 0 },
            { id: Date.now() + 725, categoryId: 11, name: 'J-026', costPrice: 50, salePrice: 100, soldCount: 0 },
            { id: Date.now() + 726, categoryId: 11, name: 'J-027', costPrice: 160, salePrice: 200, soldCount: 0 },
            { id: Date.now() + 727, categoryId: 11, name: 'J-028', costPrice: 135, salePrice: 250, soldCount: 0 },
            { id: Date.now() + 728, categoryId: 11, name: 'J-029', costPrice: 430, salePrice: 500, soldCount: 0 },
            { id: Date.now() + 729, categoryId: 11, name: 'J-030', costPrice: 215, salePrice: 300, soldCount: 0 },
            { id: Date.now() + 730, categoryId: 11, name: 'J-031', costPrice: 135, salePrice: 200, soldCount: 0 },
            { id: Date.now() + 731, categoryId: 11, name: 'J-032', costPrice: 50, salePrice: 100, soldCount: 0 },
            { id: Date.now() + 732, categoryId: 11, name: 'J-033', costPrice: 200, salePrice: 250, soldCount: 0 },
            { id: Date.now() + 733, categoryId: 11, name: 'J-034', costPrice: 180, salePrice: 250, soldCount: 0 },
            { id: Date.now() + 734, categoryId: 11, name: 'J-035', costPrice: 50, salePrice: 100, soldCount: 0 },
            { id: Date.now() + 735, categoryId: 11, name: 'J-036', costPrice: 160, salePrice: 250, soldCount: 0 },
            { id: Date.now() + 736, categoryId: 11, name: 'J-037', costPrice: 200, salePrice: 250, soldCount: 0 },
            { id: Date.now() + 737, categoryId: 11, name: 'J-038', costPrice: 180, salePrice: 250, soldCount: 0 },
            { id: Date.now() + 738, categoryId: 11, name: 'J-039', costPrice: 240, salePrice: 350, soldCount: 0 },
            { id: Date.now() + 739, categoryId: 11, name: 'J-040', costPrice: 125, salePrice: 200, soldCount: 0 },
            { id: Date.now() + 740, categoryId: 11, name: 'J-041', costPrice: 100, salePrice: 150, soldCount: 0 },
            { id: Date.now() + 741, categoryId: 11, name: 'J-042', costPrice: 300, salePrice: 350, soldCount: 0 },
            { id: Date.now() + 742, categoryId: 11, name: 'J-043', costPrice: 205, salePrice: 300, soldCount: 0 },
            { id: Date.now() + 743, categoryId: 11, name: 'J-044', costPrice: 250, salePrice: 300, soldCount: 0 },
            { id: Date.now() + 744, categoryId: 11, name: 'J-045', costPrice: 120, salePrice: 200, soldCount: 0 },
            { id: Date.now() + 745, categoryId: 11, name: 'J-046', costPrice: 280, salePrice: 350, soldCount: 0 },
            { id: Date.now() + 746, categoryId: 11, name: 'J-047', costPrice: 250, salePrice: 300, soldCount: 0 },
            { id: Date.now() + 747, categoryId: 11, name: 'J-048', costPrice: 380, salePrice: 500, soldCount: 0 },
            { id: Date.now() + 748, categoryId: 11, name: 'J-049', costPrice: 160, salePrice: 250, soldCount: 0 },
            { id: Date.now() + 749, categoryId: 11, name: 'J-050', costPrice: 190, salePrice: 250, soldCount: 0 }
        ];
    }
